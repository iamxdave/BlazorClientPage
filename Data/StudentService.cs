        ...
        public StudentService()
        {
            _students = new List<Student>
            {
                new Student
                {
                    ...
                    Studies = "Test",
                    Avatar = "https://crystalmountain-wisla.pl/wp-content/uploads/revslider/slider-glowny/wyszparowany-adam.png"
                },
                new Student
                {
                    ID = 2,
                    ...
                    Studies = "Test",
                    Avatar = "https://fightpages.com/faces-no-bg/mariuszpudzianowski11481247.png"
                },
                new Student
                {
                    ID = 3,
